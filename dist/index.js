...
const env_variables_1 = __webpack_require__(265);
function run() {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        const envVariables = env_variables_1.readEnvVariables();
        const title = utils_1.replaceGitHubUsernameWithSlackUsername((_a = envVariables.attachmentsTitle, (_a !== null && _a !== void 0 ? _a : '')), (_b = envVariables.slackGithubPairs, (_b !== null && _b !== void 0 ? _b : '')));
        const body = utils_1.replaceGitHubUsernameWithSlackUsername((_c = envVariables.attachmentsBody, (_c !== null && _c !== void 0 ? _c : '')), (_d = envVariables.slackGithubPairs, (_d !== null && _d !== void 0 ? _d : '')));
...
exports.replaceGitHubUsernameWithSlackUsername = (text, usernames) => {
    var _a;
    const githubToSlack = (_a = usernames.split('\n').reduce((result, row) => {
        const res = row.split(',');
        const key = res[0];
        const value = res[1];
        if (!value) {
